...
def _entry(label_en: str, label_zh: str, value_en: Any, value_zh: Any | None = None) -> dict[str, Any]:
    return {
        "label_en": label_en,
        "label_zh": label_zh,
        "value_en": value_en,
            ...
            "sections": [
                ...
                },
                {
                    ...
                    "items": [
                        ...
                        _entry("Curve", "刘海弧度", bangs.curve, self._zh_curve(bangs.curve)),
                ...
                },
                {
                    ...
                    "section_zh": "妆容",
                    "items": [
                        _entry("Base finish", "底妆质感", makeup.base_makeup.finish, self._zh_base_finish(makeup.base_makeup.finish)),
            ...
            "sections": [
                ...
                },
                {
                    ...
                    "items": [
                        ...
                        _entry("Target bangs", "目标刘海", bangs.type if bangs.exists else "none", self._zh_bangs_type(bangs.type) if bangs.exists else "无刘海"),
                    ],
                },
                {
                    ...
                    "items": [
                        ...
                        _entry("Eyebrow target", "眉毛目标", f"{makeup.eyebrow.shape} / {makeup.eyebrow.color}", f"{self._zh_brow_shape(makeup.eyebrow.shape)} / {self._zh_color(makeup.eyebrow.color)}"),
                        _entry("Eyeshadow target", "眼影目标", makeup.eyeshadow.main_color, self._zh_color(makeup.eyeshadow.main_color)),
                        _entry("Eyeliner target", "眼线目标", f"{makeup.eyeliner.style} / {makeup.eyeliner.color}", f"{self._zh_eyeliner_style(makeup.eyeliner.style)} / {self._zh_color(makeup.eyeliner.color)}"),
